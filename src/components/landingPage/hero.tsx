            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ opacity: { delay: 1.7, duration: 0.4 }, scale: { delay: 1.7, duration: 0.4 }, y: { delay: 2.1, duration: 4, repeat: Infinity, ease: "easeInOut" } }}
                ...
                <motion.div
                  initial={{ opacity: 0, scale: 0 }}
                  animate={{ opacity: 1, scale: 1, y: [10, -10, 10] }}
                  transition={{ opacity: { delay: 1.9, duration: 0.4 }, scale: { delay: 1.9, duration: 0.4 }, y: { delay: 2.3, duration: 5, repeat: Infinity, ease: "easeInOut" } }}
